...
namespace ucpPabd
{
    public partial class reportsaldo: Form
    {
        public reportsaldo()
        {
            InitializeComponent();
        ...
        private void reportsaldo_Load(object sender, EventArgs e)
        {
        ...
        private void SetupReportViewer()
        {
            ...
            ReportDataSource rds = new ReportDataSource("DataSetSaldo", dt); // Make sure "DataSet1" matches your RDLC dataset name
            ...
            reportViewer1.LocalReport.ReportPath = @"E:\C++\ucpPabd\ucpPabd\Reportsaldo.rdlc";
