...
namespace ucpPabd
{
    public partial class reportpemasukan : Form
    {
        ...
        private void SetupReportViewer()
        {
            ...
            string query = @"
            SELECT Pemasukan.pemasukan_id, Pemasukan.kategori, Pemasukan.jumlah, Pemasukan.tanggal, Saldo.saldo_id, Saldo.total_saldo, Saldo.tanggal_update
            FROM     Pemasukan INNER JOIN
                  Saldo ON Pemasukan.pemasukan_id = Saldo.pemasukan_id";
            ...
            reportViewer1.LocalReport.ReportPath = @"E:\C++\ucpPabd\ucpPabd\Reportpemasukan.rdlc";
